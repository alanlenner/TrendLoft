...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-07-2016 a las 03:12:07
...
('root', '[{"db":"trendloft","table":"usuario"},{"db":"trendloft","table":"imagen"},{"db":"wordpress","table":"usuarios"},{"db":"phpmyadmin","table":"pma__users"},{"db":"wordpress","table":"wp_commentmeta"}]');
...
('root', '2016-07-03 00:54:46', '{"lang":"es","collation_connection":"utf8mb4_unicode_ci"}');
...
USE `test`;
--
-- Base de datos: `trendloft`
--
CREATE DATABASE IF NOT EXISTS `trendloft` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `trendloft`;
...
CREATE TABLE `usuarios` (
  ...
  `publicidad` enum('Si','No') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
