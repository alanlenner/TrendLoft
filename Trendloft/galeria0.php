  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="resources/images/galeria/foto1.jpg" alt="Chania" width="460" height="345">
      ...
      <div class="item">
        <img src="resources/images/galeria/foto2.jpg" alt="Chania" width="460" height="345">
        <div class="carousel-caption">
          <h3>Chania</h3>
          <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
        </div>
      ...
      <div class="item">
        <img src="resources/images/galeria/foto3.jpg" alt="Flower" width="460" height="345">
        <div class="carousel-caption">
          <h3>Flowers</h3>
